            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="space-y-6">
                <h1 className="text-6xl lg:text-7xl font-bold tracking-tight leading-tight">
                  Hi! I'm{' '}
                  <span className="text-[hsl(var(--secondary))]">Cem</span>.
                </h1>

                <h2 className="text-3xl lg:text-4xl font-light text-primary-foreground/90">
                  Product Manager
                </h2>

                <p className="text-xl text-primary-foreground/80 leading-relaxed max-w-lg">
                  I'm a Product Manager based in Munich, Germany. I have over 5
                  years' blended experience in product roles across B2C and B2B.
