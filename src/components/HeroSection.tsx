...
const HeroSection = () => {
  ...
  if (showMap) {
    return (
      <section
        id="hero"
        className="hero-section min-h-[100vh] pt-0 pb-[25vh] flex items-center justify-center transition-all duration-700 ease-in-out"
      >
  ...
  return (
    <section
      id="hero"
      className="hero-section min-h-[140vh] pt-0 pb-[10vh] flex items-center justify-center transition-all duration-700 ease-in-out"
    >
